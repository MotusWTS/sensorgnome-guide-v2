...
Either of the methods described above will also work on a smartphone if needed. It can be more difficult to connect to the SG's hotspot with a smartphone because many phones will ignore a hotspot without internet access if you still have internet by other means. For this reason, it's best to turn off your phone's cell network and disconnect from or forget other WiFi if they are within range.&#x20;
